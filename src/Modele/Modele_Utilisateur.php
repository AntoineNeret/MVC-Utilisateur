...
select *
    ...
    public static function Utilisateur_Insert(string $nom, string $prenom, string $motDePasse)
    {
        $connexionPDO = Singleton_ConnexionPDO::getInstance();
        $requetePreparee = $connexionPDO->prepare('
    ...
    public static function Utilisateur_Update(mixed $id, string $nom, string $prenom, string $motDePasse)
    {
        $connexionPDO = Singleton_ConnexionPDO::getInstance();
        $requetePreparee = $connexionPDO->prepare('
